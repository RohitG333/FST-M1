...
public class Activity13_2a {
	...
	public void writeExcel(String filePath) throws IOException {
        ...
        String[] row1 = {"1", "Rohan", "Shah", "rohansh@example.com", "6776763733"};
        String[] row2 = {"2", "Jack", "Kati", "jackk@example.com", "6545654654"};
        String[] row3 = {"3", "ken", "math", "ken.math@example.com", "5646235478"};
